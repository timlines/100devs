...
function partyPurple () {
  ...
  document.getElementById('imageid').src = 'img/chair_purple.png';
}

function partyGreen () {
  document.querySelector('body').style.backgroundColor = COLOR_GREEN;
  document.querySelector('body').style.color = 'white';
  document.getElementById('imageid').src = 'img/chair_green.png';
}
...
function partyBlue () {
  ...
  document.querySelector('body').style.color = 'white';
  document.getElementById('imageid').src = 'img/chair_blue.png';
}
...
function partyRed () {
  ...
  document.querySelector('body').style.color = 'white';
  document.getElementById('imageid').src = 'img/chair_red.png';
}